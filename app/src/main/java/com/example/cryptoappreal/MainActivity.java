        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (!checkNetwork() == true){
                    Toast.makeText(MainActivity.this, "No Internet, pal!", Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(MainActivity.this, "Network Connection isn't the problem ", Toast.LENGTH_LONG).show();
...
//        MenuItem menuSearchItem = menu.findItem(R.id.);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.on_options_aboutButton){
